export const copy = {
  ...
  hi: {
    badge: ' Labor Hub',
    headline: ' ke liye saaf aur asaan hiring platform',
    subheadline:
    ...
    allCitiesAvailable: ' me available hai',
    footerBenefits: ' me opportunities • Better worker-employer matching • Professional first impression',
    ...
    labourSubtitle:
      'Skill update rakhiye, profile saaf rakhiye aur  ke matching jobs dekhiye.',
    activeLabours: 'Available labour',
    liveJobs: 'Live jobs',
    avgRating: 'Avg rating',
    hiresToday: 'Aaj hire',
    ...
    availableLaboursTitle: ' me available labour',
    ...
    focus: 'Primary area: ',
    focusBody:
      'Platform sabse pehle  ke jobs aur labour ko highlight karta hai.',
